...
class UserService:
    ...
    async def create_admin_user(self, db: AsyncSession) -> UserCredsSchema | None:
    ...
    async def create_user(
        ...
        # vs = await self.vs_repo.get_default_storage(db)
        # if not vs:
        #     raise HTTPException(
    ...
    async def select_storage(
        ...
        # implement later, but keep db as explicit arg
